    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold">Edit Menu Item</h2>
            </div>
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit',
        href: route('dashboard.menu-items.edit', { menu_item: props.menuItem.id }),
    },
];
...
const form = useForm({
    ...
    image_url: props.menuItem.image_url,
    description: props.menuItem.description,
    is_available: props.menuItem.is_available
});

const submit = () => {
    form.put(route('dashboard.menu-items.update', props.menuItem.id));
};
</script> 